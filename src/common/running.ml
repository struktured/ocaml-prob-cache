(* Running descriptive statistics; keep track of the hard bits
   via recurrence equations. Original code is from the Ocaml Math Library 
   (https://github.com/rleonid/oml). This code will be deleted when Oml
   get's officially released. *)
