...
(* OASIS_START *)
(* DO NOT EDIT (digest: 54e20f08f5e00dc50352009d92884d7a) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Model_intf"; "Set_model"; "Sequence_model"];
                      lib_pack = false;
                      lib_internal_modules = ["Model_impl"];
                      lib_findlib_parent = Some "prob_cache";
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "sprinkler.ml"});
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "coin_flip.ml"});
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "riak"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.6";
     oasis_digest =
       Some "\195\209\023\224<[\023\241\180\128\249\225w.\149\181";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
