...
(* OASIS_START *)
(* DO NOT EDIT (digest: fccda7e55ae1d7dd2de8f02ea8456375) *)
(*
...
let setup_t =
  {
            ...
            OCamlbuildDocPlugin.doc_build
              {
                 ...
                 run_path = "src/examples"
              });
          ("prob_cache_containers",
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args =
                   [
            ...
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args =
                   [
                      "-docflags '-colorize-code -html -short-functors -charset\028 utf-8'"
                   ];
                 run_path = "src/riak"
              })
       ];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Enable/Disable riak cache backend";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Enable/Disable containers cache backend";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Enable/Disable example support library";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                     cs_name = "containers_examples";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description =
                        Some "Enable/Disable containers api examples";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                     cs_name = "riak_examples";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description =
                        Some "Enable/Disable riak api examples";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules =
                        [
                           "Prob_cache_phashtbl";
                           "Prob_cache_hashset";
                           "Prob_cache_update_rules";
                           "Prob_cache_options";
                           "Prob_cache_update_rule_option";
                           "Prob_cache_running";
                           "Prob_cache_data";
                           "Prob_cache_events";
                           "Prob_cache_prior";
                           "Prob_cache_entry";
                           "Prob_cache_calculus";
                           "Prob_cache_create_fun";
                           "Prob_cache_observe_data_fun";
                           "Prob_cache_data_fun";
                           "Prob_cache_fold";
                           "Prob_cache_fold_fun";
                           "Prob_cache_model_primitives";
                           "Prob_cache_model_kernel";
                           "Prob_cache_model_decorator";
                           "Prob_cache_model";
                           "Prob_cache"
                        ];
                      lib_pack = false;
                      lib_internal_modules = ["Prob_cache_powerset"];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.ENot (OASISExpr.EFlag "examples"),
                             false)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "prob_cache"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules =
                        ["Prob_cache_coin_flip"; "Prob_cache_sprinkler"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "prob_cache";
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.ENot (OASISExpr.EFlag "containers"),
                             false)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ppx_deriving.iter", None);
                           FindlibPackage ("ppx_deriving_protobuf", None);
                           FindlibPackage ("or_errors_containers", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   },
                   {
                      lib_modules =
                        [
                           "Containers_model_intf";
                           "Containers_set_model";
                           "Containers_sequence_model";
                           "Prob_cache_containers"
                        ];
                      lib_pack = false;
                      lib_internal_modules = ["Containers_model_impl"];
                      lib_findlib_parent = Some "prob_cache";
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
                 ...
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, true);
                           (OASISExpr.EFlag "riak", true);
                           (OASISExpr.ENot (OASISExpr.EFlag "riak"), false)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/riak";
                      bs_compiled_object = Best;
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Riak_model_impl"];
                      lib_findlib_parent = Some "prob_cache";
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
                 ...
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, true);
                           (OASISExpr.EFlag "containers_examples", true);
                           (OASISExpr.ENot
                              (OASISExpr.EFlag "containers_examples"),
                             false)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/containers_examples";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [
                           InternalLibrary "containers";
                           InternalLibrary "examples"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "containers_sprinkler.ml"
                   });
               Executable
                 ({
                     cs_name = "containers_coin_flip";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "containers_coin_flip.ml"
                   });
               Executable
                 ({
                     cs_name = "riak_sprinkler";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, true);
                           (OASISExpr.EFlag "riak_examples", true);
                           (OASISExpr.ENot (OASISExpr.EFlag "riak_examples"),
                             false)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/riak_examples";
                      bs_compiled_object = Byte;
                      bs_build_depends =
                        [InternalLibrary "riak"; InternalLibrary "examples"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "riak_sprinkler.ml"});
               Executable
                 ({
                     cs_name = "riak_coin_flip";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "riak_coin_flip.ml"});
               Doc
                 ({
                     cs_name = "prob_cache";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "Probability Cache API";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "Probability Cache Examples Support API";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "Probability Containers Cache API";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "Probability Riak Cache API";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest =
       Some "\003\141\232\151\149\235\178\226\149\127\219\232\210\181\224\"";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
