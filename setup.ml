...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2887018ae4f15166e13fe13383d58b90) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("containers.pervasives", None);
                   ...
                   {
                      lib_modules = ["Update_rules"; "Data"; "Events_common"];
                      lib_pack = true;
                      lib_internal_modules = ["Powerset"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "prob_cache_common";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "prob_cache_common";
                           FindlibPackage ("containers", None);
                           FindlibPackage ("containers.misc", None);
                           FindlibPackage ("containers.data", None);
                           FindlibPackage ("containers.advanced", None);
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "prob_cache_containers";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = ["Model_impl"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "prob_cache_riak";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [InternalLibrary "prob_cache_containers"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "prob_cache_riak"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "Probability Common Cache API";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\175\225\221\135\025\026\166\015\132\021V\248t\162\219\185";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
